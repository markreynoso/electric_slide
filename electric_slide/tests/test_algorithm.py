...
def test_manhattan_distance_returns_an_int(scramble_complexity_6):
    """Test manhattan distance returns an instance of an int."""
    from electric_slide.scripts.algorithm import manhattan_distance
    assert isinstance(manhattan_distance(scramble_complexity_6), int)


def test_manhattan_dist_returns_corr_heuristic(scramble_complexity_6):
    """Test that heuristic value returned is correct."""
    from electric_slide.scripts.algorithm import manhattan_distance
    assert manhattan_distance(scramble_complexity_6) == 6
...
def test_astar_correctly_terminates(scramble_complexity_6):
    """Test that astar will correctly solve a scrambled board state."""
    from electric_slide.scripts.algorithm import a_star
    assert a_star(scramble_complexity_6)


def test_astar_correctly_returns_path_of_moves(scramble_complexity_6):
    """Test that astar returns a list of board states to the solution."""
    from electric_slide.scripts.algorithm import a_star
    assert isinstance(a_star(scramble_complexity_6), list)


def test_astar_returns_list_solved_state_as_last_entry(scramble_complexity_6):
    """Test solved board states list correctly contains final solved state."""
    from electric_slide.scripts.algorithm import a_star
    solved_board = [[1, 2, 3], [4, 5, 6], [7, 8, 9]]
    assert solved_board in a_star(scramble_complexity_6)
...
def test_astar_correctly_solves_complexity_2(scramble_complexity_2):
    """Test that astar solves correctly for low heuristic values."""
    from electric_slide.scripts.algorithm import a_star
    assert len(a_star(scramble_complexity_2)) == 3
